...
from chatdev.process_agent import  generate_new_chain
...
class ChatChain:
    ...
    def __init__(self,
        ...
        self.web_spider = ""
         ...
         #process_agent: change the original chain
        # trace_list = ['DesignReview', 'DemandAnalysis', 'Coding', 'CodeReviewComment', 'TestModification', 'CodeComplete', 'CodeReviewModification', 'Annotation', 'TestErrorSummary']
        self.trace_list = trace_list
        self.chain  = generate_new_chain(self.trace_list, self.chain)
    ...
    def execute_step(self, phase_item: dict):
        ...
        if phase_type == "SimplePhase":
            ...
            if phase in self.phases:
                if phase == "DesignReview":  # Deal with DesignReview
                    self.phases[phase].chat_chain_instance = self
    ...
    def execute_chain(self):
        ...
        for phase_item in self.chain:        
            ...
            if self.chat_env.env_dict['break_flag']:
                break
